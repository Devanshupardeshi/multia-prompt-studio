...
export const INDIAN_CURRENCY_SPEC = [
  ...
  "A note is identified by its COLOUR, its SIZE and its reverse MOTIF. That is all that is needed, and it is all that should be attempted.",
  ...
  "",
  "STYLISED, NEVER A FACSIMILE. This is campaign artwork, not a reproduction. Notes are depicted the way a designer illustrates money — the right colour, the right proportions, the general layout suggested — and never as a faithful, flat-on, full-face copy. Show them folded, fanned, rolled, stacked, partially overlapped, seen at an angle, cropped by the frame, or with the far side out of focus. No security features of any kind: no watermark, no security thread, no see-through register, no microprint, no serial number. No attempt at the portrait as an accurate engraved likeness. A poster note should read as a note at a glance and be obviously unusable as anything else.",
  "- Notes, physically: matte paper with a faint fibre grain, real thickness at the edges, a soft central fold, slightly furred corners, gentle curl where it is held or stacked. Ink sits absorbed and matte, never glossy, never printed on card, never crisp like freshly cut plastic.",
  ...
  "",
  "NO TEXT ON THE MONEY. The poster's no-generated-text rule applies fully here: no denomination numerals, no language panel, no signature, no year, no serial. Where printing would sit, render soft indistinct tone at a scale or focus where it reads as texture, and never invent garbled pseudo-numerals or fake script. The ₹ symbol and the lion capital are permitted as struck or printed marks.",
  "",
  "NEVER RENDER: a flat, front-on, complete and accurate copy of a banknote, or any security feature — this is decorative campaign art and must never resemble a reproduction; dollars, cents, euros, pounds, yen, dirhams or any foreign note or coin; a $, €, £ or ¢ sign anywhere; green-toned banknotes of any kind; blank unmarked gold or silver discs standing in for coins; a flat vector or emoji-style coin or note; a plain coloured rectangle standing in for a banknote; the withdrawn ₹2000 magenta note; the demonetised pre-2016 ₹500 and ₹1000 notes; invented denominations, fantasy currency or scrambled pseudo-numerals on a note face; money mixed from two different countries in one image.",
].join("\n");
...
const HERO_MATERIALS: Record<string, string> = {
  ...
  "paper-currency": "Indian banknote paper with visible fibre, soft folds and matte absorbed ink — stylised, never a facsimile",
};
