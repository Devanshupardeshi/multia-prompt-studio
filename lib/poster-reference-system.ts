...
- Invent one original visual metaphor per brief. Do not default to cliché stock-photo tropes (a plain handshake, a generic rising arrow, a bare piggy bank, a bare coin stack, bulls/bears) unless the brief specifically requires that exact symbol.
